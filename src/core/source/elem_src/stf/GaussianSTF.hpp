...
class GaussianSTF : public STF {
  public:
  // constructor
  GaussianSTF(double halfDuration, double decayFactor, double timeShift, int derivativeOrder) :
      mHalfDuration(halfDuration), mDecayFactor(decayFactor), mTimeShift(timeShift),
