...
// initialize
void
ElementIO_NetCDF::initialize(const std::string& groupName,
    int numRecordSteps,
  ...
  // base
  ElementIO::initialize(groupName, numRecordSteps, channels, npnts, naGrid, elemNaInfo, elemCoords);
  ...
  for (int ielem = 0; ielem < nelem; ielem++) {
    ...
    int nagIndex = naGridIndexDict[nag];
    elemNaInfo5(ielem, 4) = elemNaInfo5(ielem, 3) + firstElemNaGridRanks[mpi::rank()][nagIndex];
  }
  ///////////////////////////////////////////////////////////////////////
