...
class MultilevelTimer {
  ...
  // activate
  void
  activate(const std::string& fileName);
  ...
  // begin a sub-process
  void
  begin(const std::string& procName, char indentFill = '.');

  // messaging during a sub-process
  void
  message(const std::string& what, char indentFill = '.');

  // end a sub-process
  void
  ended(const std::string& procName, char indentFill = '.');
